    ...
    #기상청
        ...
        while not self.threadStop:
            ...
            if temp < 15:#1단계 난방(모터 반시계) 강
                ...
                if humi<50 and not self.water.isState():
                    self.water.on()
                elif humi>60 and self.water.isState():
                    self.water.off()
                ...
                if humi<50 and not self.water.isState():
                    self.water.on()
                if humi>60 and self.water.isState():
                    self.water.off()
                ...
                if humi<30:
                    self.water.on()
                if humi>40 and self.water.isState():
                    self.water.off()
                    
            elif temp > 28:#5단계 냉방(모터 반시계) 중
                self.motor.run(5)
                if humi<30 and not self.water.isState():
                    self.water.on()
                if humi>40 and self.water.isState():
                    self.water.off()
                ...
                self.motor.stop()
                if humi>55 and self.water.isState():
                    self.water.off()
                if humi < 40 and not self.water.isState():
                    self.water.on()
